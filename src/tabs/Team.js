...
import { TeamDialog } from './cmpt/ResultDialogs.js';
...
export default function Team() {
    ...
    const onSubmit = data => {
      ...
      fetch( `https://kicker-almanac-backend.herokuapp.com/teams?name=${data.team}` )
    ...
    return (<>
      ...
      <TeamDialog showDialog={showDialog} setShowDialog={setShowDialog} content={dialogContent} />
    </>)
}
